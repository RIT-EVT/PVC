...
/**
 * Represents the common functionality of the PVC between DEV1 and KEV1N
 */
class PreChargeBase {
public:
    /**
     ...
     */
    PreChargeBase(IO::GPIO& key, IO::GPIO& batteryOne, IO::GPIO& batteryTwo,
